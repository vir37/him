        ...
        <div class="row between">
            ...
            <div class="section">
                ...
                <div class="catalog">
                    ...
                    <header class="catalog__main-title title">
                        <h1><?= "$header в {$city->name_pp}" ?></h1>
                    </header>
                    <div class="catalog__list row i-strech between">
                        {set
                    <?php
                        if ($current_category) {
                            $count = 1;
                    ...
                    <article class="catalog__text text text_big"">
                        <?php
                            if ($current_category) {
